...
> and named them `edx.local.dev.pem` and `edx.local.dev.key`.

##### 2. Configure Nginx

To generate certificate through mkcert and update Nginx configuration, just run:
`bin/setup-ssl`
